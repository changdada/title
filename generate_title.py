...
def main():
    ...
    try:
        ...
        pass
    # try:
    #     fw = open("D://桌面//桌面图标//学习文件//软件杯//标题生成数据//test_data_demo//1.json", 'a', encoding='utf-8')
    #
    #     test_with_title = []
    #
    #
    #     f =  open("D://桌面//桌面图标//学习文件//软件杯//标题生成数据//test_data_demo//test_no_title.json", 'r', encoding='utf-8')
    #     data = json.load(f)
    #     print(data)
